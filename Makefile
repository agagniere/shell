...
#    Updated: 2017/02/27 17:07:42 by angagnie         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LINE_EDITION_SRC := actions print_cmd home_end go_up_and_down ctrl_right_left check_word check_space cut_cpy_paste ctrl_up_down right_left delete_backspace ctrl_l
